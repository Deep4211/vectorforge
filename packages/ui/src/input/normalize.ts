...
/**
 * Normalize a raw DOM `PointerEvent` into the engine's framework-agnostic
 ...
 */
export function toEngineInput(e: PointerEvent, rect: DOMRect, viewport: Viewport): EngineInput {
